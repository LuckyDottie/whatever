...
var repeatContentOfBrackets = require('../src/repeatSubstring');
describe('repeatSubstring test cases', function(){
    ...
    it('should return dddddd', function(){
        assert.equal('dddddd', repeatContentOfBrackets('2[3[d]]'));
    });
    ...
    it('should return x[tyx[tyx[ty]', function(){
        assert.equal('x[tyx[tyx[ty]', repeatContentOfBrackets('3[x[ty]]'));
    });
});